    ...
    do {
        ...
        switch(choice) {
            case 1: {
                ...
                tambahBuku(&head, &undo, judul, jumlah);
                break;
            }
            case 2: {
                system("cls");
                ...
                pinjam(head, &undo, pilihan, nama, prioritas);
                break;
            }
            case 3: {
                system("cls");
            ...
            case 4: {
                ...
                do {
                    ...
                    Buku* selectedBook = getPosisiBuku(history.peminjam, pilihanBuku);
                    address currentPerson = selectedBook->first;
                    int personCount = 0;
            ...
            case 5: {
                hapusAntrian(&head);
                hapusAntrian(&(history.peminjam));
                hapusAntrian(&(undo.top));
                break;
            }
            default:
